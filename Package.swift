...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.0/UnionChat.xcframework.zip",
            checksum: "8f7f37f546732c82582ce68fc19170c03c88a83da91de75cceb8033483129cb4"
        )
    ]
)
