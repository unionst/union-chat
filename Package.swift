...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.8/UnionChat.xcframework.zip",
            checksum: "be2846df4ad9542c85fcd91f79083af3b524c1bdeef357271bc607ce407ef98c"
        )
    ]
)
