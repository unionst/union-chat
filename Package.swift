...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.12/UnionChat.xcframework.zip",
            checksum: "34b94f324b5262f2bce7c429c143b6d523bfe1a8a9f18510662a8e3dc3de4695"
        )
    ]
)
