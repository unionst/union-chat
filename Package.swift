...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.7.1-beta.11/UnionChat.xcframework.zip",
            checksum: "65041b8ed61e98b5b046a47914b4b890775c50b11644d2bdc861e3d1833caa73"
        )
    ]
)
