...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.16/UnionChat.xcframework.zip",
            checksum: "cce7243329afe2da8e41379597b9bff1d708e5f0612a80f89c25c760d0407552"
        )
    ]
)
