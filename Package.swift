...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.17/UnionChat.xcframework.zip",
            checksum: "2243851b7d576f8463c568da8c7c4220ea3ffdb19489954de7d65a7466a354a7"
        )
    ]
)
