...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.7.1-beta.5/UnionChat.xcframework.zip",
            checksum: "7e28dd72c82652eb36e2f6e126aa4e75bcbfde15c81d01f2ca4b395f20dcaa10"
        )
    ]
)
