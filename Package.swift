...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.5/UnionChat.xcframework.zip",
            checksum: "1d71d64cb085a5793d6af3d74a2fadb0d1369e094246b79d0f63b46a70e9aaa1"
        )
    ]
)
