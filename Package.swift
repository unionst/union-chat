...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.4/UnionChat.xcframework.zip",
            checksum: "c39c85ac53b8368bbce5e3c86024bd7930a9b6b851bb2dfffff8898b5bc060fb"
        )
    ]
)
