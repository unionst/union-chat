...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.14/UnionChat.xcframework.zip",
            checksum: "3f0857e9d2c68b4cd4fe9a8eca75f8a8991bef506e3755b00644608c05e4e465"
        )
    ]
)
