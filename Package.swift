...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.11/UnionChat.xcframework.zip",
            checksum: "2b5aef27f1f51f6d103273876d9d00e9a3e704546bc22adf763c30b8a9553dcf"
        )
    ]
)
