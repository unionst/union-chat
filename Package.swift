...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.6.2/UnionChat.xcframework.zip",
            checksum: "01aedebf151e89eb14798b45942a927376e797dd313c4c57fbd8b74e0a086957"
        )
    ]
)
