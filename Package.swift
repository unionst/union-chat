...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/unionst/union-chat/releases/download/0.7.1-beta.4/UnionChat.xcframework.zip",
            checksum: "67f103556f0db8db79f0791e43c0d5653fb20542063a61528ea7ffde0660845e"
        )
    ]
)
